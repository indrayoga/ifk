...
class Msubgolongan extends CI_Model {
	...
	function ambilDataSubGolongan($sub_golongan){
		if(!empty($sub_golongan)) $this->db->like('sub_golongan',$sub_golongan);
			$this->db->order_by('kd_sub','asc');
			
			//$query=$this->db->get('acc_customers,accounts');
			$query=$this->db->get('apt_sub_golongan');
