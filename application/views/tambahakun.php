            <form class="form-horizontal" action="<?php echo base_url() ?>index.php/akun/simpanAkun" method="post" >
            <!-- #content -->
            <div id="content">
                <!-- .outer -->
                                        ...
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><button type="button" onclick='window.location.href="<?php echo base_url() ?>index.php/akun"' class="btn"> <i class="icon-list"></i> Daftar</button></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                    	<input type="hidden" id="akunlama" name="akunlama" value="<?php if(!empty($akun)) echo $akun; ?>" />
