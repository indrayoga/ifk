...
$(document).ready(function() {
    $('#cetak').click(function(){
        ...
        window.location.href='<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpobulananpsikotropika/'+bulan+'/'+tahun+'/'+kd_unit_apt;
    })
});
</script>
			<div id="error"></div>
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>LAPORAN PENGGUNAAN OBAT SAS</h5>
                                            <!-- .toolbar -->
