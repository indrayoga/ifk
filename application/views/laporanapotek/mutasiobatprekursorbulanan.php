...
$(document).ready(function() {
    $('#cetak').click(function(){
        ...
        window.location.href='<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpobulananprekursor/'+bulan+'/'+tahun+'/'+kd_unit_apt;
    })
});
</script>
			<div id="error"></div>
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>LAPORAN PENGGUNAAN SEDIAAN PREKURSOR</h5>
                                            <!-- .toolbar -->
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form id="form" class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/laporanapt/sediaanprekursor">                                                
