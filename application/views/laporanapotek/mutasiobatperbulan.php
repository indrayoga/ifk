...
$(document).ready(function() {
    $('#cetak').click(function(){
        ...
        window.location.href='<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpobulanan2/'+bulan+'/'+bulan1+'/'+tahun+'/'+kd_unit_apt+'/'+kd_nomenklatur+'/'+bulan_kebutuhan+'/'+kategori;
    })
});
</script>
			<div id="error"></div>
                                                        ...
                                                        <tbody id="listmutasi">
                                                            ...
                                                            ?>
                                                                <tr style="font-size:80% !important;">
                                                                    ...
                                                                    <td style="text-align:right;width:15px !important;"><?php if($opt>0)echo number_format($item['saldo_akhir']/$opt,0,'.',','); else echo 0; ?></td>
