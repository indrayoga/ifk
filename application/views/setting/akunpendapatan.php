                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/simpanakunpendapatan">
                                                <div class="row-fluid">
                                                    <div style="width: 45%; float: left;">
                                                        ...
                                                        <select id="box1View" multiple="multiple" name="akunkas[]" style="width: 100%;" size="16">
                                                            <?php
                                                            $kas=unserialize($akunkas['setting']);
                                                            foreach ($dataakun as $akun) {
                                                                # code...
                                                                if(in_array($akun['account'], $kas))continue;
                                                            ?>
                                                            <option value="<?php echo $akun['account'] ?>"><?php echo $akun['account'].' '.$akun['name'] ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div style="width: 45%;float: left;">
                                                        ...
                                                        <select id="box2View" name="akunpendapatan[]" multiple="multiple" style="width: 100%;" size="16">
                                                            <?php
