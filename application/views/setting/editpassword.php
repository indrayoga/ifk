    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/setting/periksauserpassword";
                //console.log($.param(a));
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/updateuserpassword">                                               
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <select name="id_pegawai" id="id_pegawai" class="input-large">
                                                                    ...
                                                                    foreach ($datapegawai as $pegawai) {
                                                                        # code...
                                                                        if($pegawai['id_pegawai']==$item['id_pegawai'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                                    <option value="<?php echo $pegawai['id_pegawai'] ?>" <?php echo $sel; ?>><?php echo $pegawai['nama_pegawai'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="password" name="password" value="" id="password" class="input-medium">
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>
                                                    </div>                                                    
