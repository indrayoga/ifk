    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/setting/periksasapmapping";
                //console.log($.param(a));
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/simpansapmapping">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label for="telepon" class="control-label">Akun SAP</label>
                                                            <div class="controls with-tooltip">
                                                                <select name="akunsap" id="akunsap" class="input-xlarge" onchange="javascript:window.location.href='<?php echo base_url() ?>index.php/setting/sapmapping/'+this.value">
                                                                    <option value="">--Pilih Akun SAP--</option>
                                                                    <?php

                                                                    foreach ($dataakunsap as $akunsap) {
                                                                        # code...
                                                                        if($akunsap1==$akunsap['account'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                                    <option value="<?php echo $akunsap['account'] ?>" <?php echo $sel; ?>><?php echo $akunsap['name'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </select>
