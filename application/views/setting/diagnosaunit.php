    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/setting/periksadiagnosaunit";
                //console.log($.param(a));
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/simpandiagnosaunit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label for="telepon" class="control-label">Poli</label>
                                                            <div class="controls with-tooltip">
                                                                <select name="kd_unit_kerja" id="kd_unit_kerja" class="input-xlarge" onchange="javascript:window.location.href='<?php echo base_url() ?>index.php/setting/diagnosaunit/'+this.value">
                                                ...
                                                <div class="row-fluid">
                                                    <div style="width: 45%; float: left;">
                                                        ...
                                                        <select id="box1View" multiple="multiple" name="pelayanan[]" style="width: 100%;" size="16">
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $pelayanan['kd_sub_icd'] ?>"><?php echo $pelayanan['kd_sub_icd'].'-'.$pelayanan['sub_diagnosa_icd'] ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div style="width: 45%;float: left;">
                                                        ...
                                                        <select id="box2View" name="pelayananunit[]" multiple="multiple" style="width: 100%;" size="16">
                                                            ...
                                                            foreach ($datapelayananunit as $pelayananunit) {
                                                                # code...
                                                            ?>
                                                            <option value="<?php echo $pelayananunit['kd_icd'] ?>"><?php echo $pelayananunit['kd_icd'].'-'.$pelayananunit['sub_diagnosa_icd']; ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select><br/>
