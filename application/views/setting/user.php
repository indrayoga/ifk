    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/posting/periksauser";
                //console.log($.param(a));
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;width:160px;">
                                                            <a class="btn" href="<?php echo base_url() ?>index.php/setting/edituser/<?php echo $item['id_user'] ?>">Edit Akses</a>
                                                            <a class="btn" href="<?php echo base_url() ?>index.php/setting/editpassword/<?php echo $item['id_user'] ?>">Edit Password</a>
                                                            <a class="btn" href="<?php echo base_url() ?>index.php/setting/hapususer/<?php echo $item['id_user'] ?>">Hapus</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
