    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/setting/periksaakunaruskas";
                //console.log($.param(a));
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/simpanakunaruskas">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label for="telepon" class="control-label">Akun Arus Kas</label>
                                                            <div class="controls with-tooltip">
                                                                <select name="akunaruskas" id="akunaruskas" class="input-xlarge" onchange="javascript:window.location.href='<?php echo base_url() ?>index.php/setting/akunaruskas/'+this.value">
                                                                    <option value="">--Pilih Akun Arus Kas--</option>
                                                                    <?php

                                                                    foreach ($dataakunaruskas as $akunaruskas) {
                                                                        # code...
                                                                        if($akunaruskas1==$akunaruskas['BARIS'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                                    <option value="<?php echo $akunaruskas['BARIS'] ?>" <?php echo $sel; ?>><?php echo $akunaruskas['LABEL'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                ...
                                                <div class="row-fluid">
                                                    <div style="width: 45%; float: left;">
                                                        ...
                                                        <select id="box1View" multiple="multiple" name="akun[]" style="width: 100%;" size="16">
                                                            <?php
                                                            foreach ($dataakun as $akun) {
                                                                # code...
                                                                //if($this->msetting->isItemMapping($unit,$pelayanan['kd_pelayanan']))continue;
                                                            ?>
                                                            <option value="<?php echo $akun['account'] ?>"><?php echo $akun['name'] ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div style="width: 45%;float: left;">
                                                        ...
                                                        <select id="box2View" name="akunkas[]" multiple="multiple" style="width: 100%;" size="16">
