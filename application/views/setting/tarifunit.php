    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/setting/periksatarifunit";
                //console.log($.param(a));
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/setting/simpantarifunit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label for="telepon" class="control-label">Poli</label>
                                                            <div class="controls with-tooltip">
                                                                <select name="kd_unit_kerja" id="kd_unit_kerja" class="input-xlarge" onchange="javascript:window.location.href='<?php echo base_url() ?>index.php/setting/tarifunit/'+this.value">
