                ...
                <div class="container-fluid outer">
                    <div class="row-fluid">
                      ...
                      <!--BEGIN INPUT TEXT FIELDS-->
						<form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/vendor/editvendor">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">		
														<input type="hidden" name="id" value="<?php echo $vend_code ?>">
														<input type="text" id="text1" name="vend_code" value="<?php if(!empty($vend_code)) echo $vend_code ?>" readonly class="span2 input-tooltip" data-original-title="masukkan kode vendor" data-placement="bottom"/>                                                        
                                                    </div>
                                                </div>
                                                <div class="control-group">
