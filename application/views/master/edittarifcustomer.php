    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/tarifcustomer/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/tarifcustomer"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/tarifcustomer/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <input type="hidden" name="kd_jenis_tarif_lama" value="<?php echo $item['kd_jenis_tarif']; ?>">
                                                <input type="hidden" name="cust_code_lama" value="<?php echo $item['cust_code']; ?>">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="cust_code" class="input-xlarge">
                                                                    <option value="">Pilih Customer</option>
                                                                    <?php
                                                                    foreach ($datacustomer as $customer) {
                                                                        # code...
                                                                    if($customer['cust_code']==$item['cust_code'])$sel="selected=selected";else $sel="";
                                                                    ?>
