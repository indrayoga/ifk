    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/jenisbayar/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/jenisbayar"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/jenisbayar/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_jenis_bayar" class="control-label">Kode</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_jenis_bayar" name="kd_jenis_bayar" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_jenis_bayar'] ?>" readonly  data-original-title="masukkan kode jenis bayar" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="jenis_bayar" class="control-label">Jenis Bayar</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="jenis_bayar" name="jenis_bayar" class="input-large input-tooltip"
                                                                        value="<?php echo $item['jenis_bayar'] ?>"   data-original-title="masukkan jenis bayar " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="tag" name="tag" class="input-large input-tooltip"
                                                                        value="<?php echo $item['tag'] ?>"   data-original-title="masukkan tag " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
