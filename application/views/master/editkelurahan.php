    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/kelurahan/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kelurahan/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_kelurahan" class="control-label">Kode Kelurahan</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kelurahan" name="kd_kelurahan" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_kelurahan'] ?>" readonly  data-original-title="masukkan kode kelurahan" data-placement="bottom"/>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kecamatan" class="input-xlarge">
                                                                        <?php
                                                                        foreach ($datakecamatan as $kecamatan) {
                                                                            # code...
                                                                            if($item['kd_kecamatan']==$kecamatan['kd_kecamatan'])$sel="selected=selected";else $sel="";
                                                                        ?>
                                                                        <option value="<?php echo $kecamatan['kd_kecamatan'] ?>" <?php echo $sel; ?>><?php echo $kecamatan['kecamatan'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kelurahan" name="kelurahan" class="input-large input-tooltip"
                                                                        value="<?php echo $item['kelurahan'] ?>"   data-original-title="masukkan kelurahan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
