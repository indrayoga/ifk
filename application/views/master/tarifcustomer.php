                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/tarifcustomer/tambah"> <i class="icon-plus"></i> Tambah</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/master/tarifcustomer">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
												...
												?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;width:160px;">
                                                            ...
                                                            ?>
                                                            <a href="<?php echo base_url() ?>index.php/master/tarifcustomer/edit/<?php echo $item['kd_jenis_tarif'] ?>/<?php echo $item['cust_code'] ?>" class="btn"><i class="icon-edit"></i> Edit</a>
                                                            <a href="<?php echo base_url() ?>index.php/master/tarifcustomer/hapus/<?php echo $item['kd_jenis_tarif'] ?>/<?php echo $item['cust_code'] ?>" class="btn btn-danger"><i class="icon-remove"></i> Hapus</a>
                                                            <?php
                                                            }
                                                            ?>
                                                        </td>
