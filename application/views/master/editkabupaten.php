    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/kabupaten/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/kabupaten"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kabupaten/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_kabupaten" class="control-label">Kode Kabupaten</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kabupaten" name="kd_kabupaten" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_kabupaten'] ?>" readonly  data-original-title="masukkan kode kabupaten" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_propinsi" class="control-label">Propinsi</label>
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_propinsi" class="input-xlarge">
                                                                        <?php
                                                                        foreach ($datapropinsi as $propinsi) {
                                                                            # code...
                                                                            //if($propinsi['kd_propinsi']==$propinsi['kd_propinsi'])$sel="selected=selected";else $sel="";
																			$select="";
																			if(isset($item['kd_propinsi'])){    
																				if($item['kd_propinsi']==$propinsi['kd_propinsi'])$select="selected=selected";else $select="";
																			}
                                                                        ?>
                                                                        <option value="<?php echo $propinsi['kd_propinsi'] ?>" <?php echo $select; ?>><?php echo $propinsi['propinsi'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kabupaten" name="kabupaten" class="input-large input-tooltip"
                                                                        value="<?php echo $item['kabupaten'] ?>"   data-original-title="masukkan kabupaten " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
