    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/jenistarif/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/jenistarif"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/jenistarif/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_jenis_tarif" class="control-label">Kode</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_jenis_tarif" name="kd_jenis_tarif" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_jenis_tarif'] ?>" readonly  data-original-title="masukkan kode jenis tarif" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="jenis_tarif" class="control-label">Jenis Tarif</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="jenis_tarif" name="jenis_tarif" class="input-large input-tooltip"
                                                                        value="<?php echo $item['jenis_tarif'] ?>"   data-original-title="masukkan jenis tarif " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
