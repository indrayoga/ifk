    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/listpelayanan/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/listpelayanan"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/listpelayanan/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_pelayanan" class="control-label">Kode</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_pelayanan" name="kd_pelayanan" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_pelayanan'] ?>" readonly  data-original-title="masukkan kode pelayanan" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="jenis_pelayanan" class="control-label">Jenis Pelayanan</label>
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_jenis_pelayanan" class="input-xlarge">
                                                                    <?php
                                                                    foreach ($datajenispelayanan as $jenispelayanan) {
                                                                        # code...
                                                                    if($jenispelayanan['kd_jenis_pelayanan']==$item['kd_jenis_pelayanan'])$sel="selected=selected";else $sel="";
                                                                    ?>
                                                                    <option value="<?php echo $jenispelayanan['kd_jenis_pelayanan'] ?>" <?php echo $sel; ?>><?php echo $jenispelayanan['jenis_pelayanan'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>  
                                                                    </select>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="nama_pelayanan" class="control-label">Pelayanan</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="nama_pelayanan" name="nama_pelayanan" class="input-large input-tooltip"
                                                                        value="<?php echo $item['nama_pelayanan'] ?>"   data-original-title="masukkan pelayanan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
