    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/admpendaftaran/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
								...
								<div class="span12">
									<div class="box">
										<header>
											...
											<h5>ADMINISTRASI PENDAFTARAN</h5>
											<!-- .toolbar -->
											<div class="toolbar" style="height:auto;">
												<ul class="nav nav-tabs">
													<!--li><button class="btn btn-primary" id="simpan" type="submit"  name="submit" value="simpan"> <i class="icon-save"></i> Simpan</button></li-->
													<li>
										...
										<div id="div-1" class="accordion-body collapse in body">
											<form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/admpendaftaran/simpan">
												<div class="row-fluid">
													<div class="span12">
														<div class="span6">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<select name="unit" id="unit" class="input-large" onchange="javascript:window.location.href='<?php echo base_url() ?>index.php/master/admpendaftaran/index/'+this.value">
																		<option value="">Pilih Unit</option>
																		<option value="IGD" <?php if($unit=='IGD') echo "selected=selected"; ?>>Instalasi Gawat Darurat</option>
																		<option value="RWJ" <?php if($unit=='RWJ') echo "selected=selected"; ?>>Rawat Jalan</option> 
																		<option value="RWI" <?php if($unit=='RWI') echo "selected=selected"; ?>>Rawat Inap</option> 
																	</select>
												...
												<div class="row-fluid">
													...
													<div style="width: 45%;float: left;">
														...
														<select id="box2View" name="pelayananunit[]" multiple="multiple" style="width: 100%;" size="16">
															...
															foreach ($datapelayananunit as $pelayananunit) {
																# code...
															?>
															<option value="<?php echo $pelayananunit['kd_pelayanan'] ?>"><?php echo $pelayananunit['nama_pelayanan']; ?></option>
															<?php
															}
															?>
														</select><br/>
												...
												<div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <button class="btn btn-primary" type="submit" name="submit" value="simpan"><i class="icon-ok"></i> Simpan</button>
