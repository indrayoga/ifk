    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/master/dokter/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/master/dokter/"> <i class="icon-list"></i> Daftar</a></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/dokter/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span6">
                                                            <div class="control-group">
                                                                <label for="kd_dokter" class="control-label">Kode</label>
																<div class="controls with-tooltip">
																	<input <?php if($this->mdokter->isPosted($kd_dokter))echo "readonly"; ?> type="text" name="kd_dokter" id="kd_dokter" class="span4 input-tooltip"
																		value="<?php if(isset($items['kd_dokter']))echo $items['kd_dokter'] ?>" data-original-title="kd dokter" data-placement="bottom"/>
													...
													<div class="span12">
														<div class="span6">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" name="nama_dokter" id="nama_dokter" class="span10 input-tooltip"
																		value="<?php if(isset($items['nama_dokter']))echo $items['nama_dokter'] ?>" data-original-title="nama dokter" data-placement="bottom"/>
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
