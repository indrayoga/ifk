                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/perawat/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span6">
                                                            <div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" name="kd_perawat" id="kd_perawat" class="span4 input-tooltip"
																		value="" data-original-title="kd perawat" data-placement="bottom"/>
															...
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" name="nama_perawat" id="nama_perawat" class="span10 input-tooltip"
																		value="" data-original-title="nama perawat" data-placement="bottom"/>
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
												...
												<div class="row-fluid">
													<div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<textarea id="alamat" name="alamat" cols="90" rows="2" class="input-xlarge" style="width:310px"></textarea>
																<span class="help-inline"></span>
															</div>
														</div>																												
													</div>
