                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Entry Diagnosa ICD</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/subdiagnosaicd"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/subdiagnosaicd/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_diagnosa_icd" class="control-label">Kode SUB Diagnosa ICD</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_sub_icd" name="kd_sub_icd" class="input-mini input-tooltip"
                                                                        value=""   data-original-title="masukkan kode sub diagnosa icd" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="no_dtd" class="control-label">Kode Diagnosa ICD</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_diagnosa_icd" name="kd_diagnosa_icd" class="input-large input-tooltip"
                                                                        value=""   data-original-title="masukkan kode diagnosa ICD" data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="sub_diagnosa_icd" class="control-label">Diagnosa</label>
                                                                <div class="controls with-tooltip">
                                                                    <textarea id="sub_diagnosa_icd" name="sub_diagnosa_icd" cols="90" rows="2" class="input-large" style="width:270px"></textarea>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
