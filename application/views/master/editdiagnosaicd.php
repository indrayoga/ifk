    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/diagnosaicd/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/diagnosaicd"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/diagnosaicd/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_diagnosa_icd" class="control-label">Kode Diagnosa ICD</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_diagnosa_icd" name="kd_diagnosa_icd" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_diagnosa_icd'] ?>" readonly  data-original-title="masukkan kd diagnosa icd" data-placement="bottom"/>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="no_dtd" name="no_dtd" class="input-large input-tooltip"
                                                                        value="<?php echo $item['no_dtd']; ?>" data-original-title="masukkan no dtd" data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <textarea id="diagnosa" name="diagnosa" cols="90" rows="2" class="input-large" style="width:270px"><?php echo $item['diagnosa'] ?></textarea>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
