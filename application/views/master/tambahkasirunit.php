                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kasirunit/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kasir" class="input-xlarge">
                                                                        ...
                                                                        foreach ($datakasir as $kasir) {
                                                                            # code...
                                                                        ?>
                                                                        <option value="<?php echo $kasir['kd_kasir'] ?>"><?php echo $kasir['kasir'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
