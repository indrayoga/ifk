                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/listpelayanan/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_pelayanan" name="kd_pelayanan" class="input-mini input-tooltip"
                                                                        value=""  data-original-title="masukkan kode pelayanan" data-placement="bottom"/>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    ...
                                                                    foreach ($datajenispelayanan as $jenispelayanan) {
                                                                        # code...
                                                                    ?>
                                                                    <option value="<?php echo $jenispelayanan['kd_jenis_pelayanan'] ?>"><?php echo $jenispelayanan['jenis_pelayanan'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>  
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="nama_pelayanan" name="nama_pelayanan" class="input-xlarge input-tooltip"
                                                                        value="" data-original-title="masukkan nama pelayanan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
