    ...
    <title><?php echo isset($title) ? $title : "" ?></title>
        ...
        <style type="text/css">
            ...
            .scrollup{
                ...
                display:none;
                text-indent:-9999px;
                background: url('<?php echo base_url() ?>images/icon_top.png') no-repeat;
            }             
        </style>        
                                ...
                                <ul class="nav">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo base_url() ?>index.php/master/jenispegawai"><i class="icon-angle-right"></i> Jenis Pegawai</a></li>
                                            <li class="dropdown submenu">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-doc-1"></i>Administrasi</a>
                                                <ul class="dropdown-menu submenu-show submenu-hide">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/admpendaftaran"><i class="icon-angle-right"></i> Administrasi Pendaftaran</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="dropdown submenu">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-doc-1"></i>Dokter</a>
                                                <ul class="dropdown-menu submenu-show submenu-hide">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/dokter"><i class="icon-angle-right"></i> Dokter</a></li>
                                                    <li class="divider"></li>
                                                    <li><a href="<?php echo base_url() ?>index.php/master/dokterunit"><i class="icon-angle-right"></i> Dokter Unit Kerja</a></li>
                                                </ul>
                                            </li>
