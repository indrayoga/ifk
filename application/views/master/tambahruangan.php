                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/ruangan/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="no_kamar" name="no_kamar" class="input-small input-tooltip"
                                                                        value=""   data-original-title="masukkan nomor kamar" data-placement="bottom"/>
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_unit_kerja" class="input-xlarge">
                                                                        ...
                                                                        foreach ($dataunit as $unit) {
                                                                            # code...
                                                                        ?>
                                                                        <option value="<?php echo $unit['kd_unit_kerja'] ?>"><?php echo $unit['nama_unit_kerja'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="jml_bed" name="jml_bed" class="input-mini input-tooltip"
                                                                        value=""   data-original-title="masukkan jumlah kasur " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
