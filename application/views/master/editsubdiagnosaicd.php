    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/subdiagnosaicd/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Edit Diagnosa ICD</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/editsubdiagnosaicd"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/subdiagnosaicd/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_diagnosa_icd" class="control-label">Kode Sub ICD</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_sub_icd" name="kd_sub_icd" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_sub_icd'] ?>" readonly  data-original-title="masukkan kd sub icd" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_diagnosa_icd" class="control-label">Diagnosa ICD</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_diagnosa_icd" name="kd_diagnosa_icd" class="input-large input-tooltip"
                                                                        value="<?php echo $item['kd_diagnosa_icd']; ?>" data-original-title="masukkan no diagnosa icd" data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
												...
												<div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="sub_diagnosa_icd" class="control-label">Sub Diagnosa</label>
                                                                <div class="controls with-tooltip">
                                                                    <textarea id="diagnosa" name="sub_diagnosa_icd" cols="90" rows="2" class="input-large" style="width:270px"><?php echo $item['sub_diagnosa_icd'] ?></textarea>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
