                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/propinsi/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_propinsi" name="kd_propinsi" class="input-mini input-tooltip"
                                                                        value=""   data-original-title="masukkan kode propinsi" data-placement="bottom"/>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="propinsi" name="propinsi" class="input-large input-tooltip"
                                                                        value=""   data-original-title="masukkan propinsi " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
