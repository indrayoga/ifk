    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/ruangan/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/ruangan"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/ruangan/update">
                                                        ...
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="no_kamar" name="no_kamar" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['no_kamar'] ?>" readonly  data-original-title="masukkan nomor kamar" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_unit_kerja" class="control-label">Unit Ruangan</label>
                                                                <div class="controls with-tooltip">
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kelas" class="input-medium">
                                                                        <?php
                                                                        foreach ($datakelas as $kelas) {
                                                                            # code...
																			$select="";
																			if(isset($item['kd_kelas'])){    
																				if($item['kd_kelas']==$kelas['kd_kelas'])$select="selected=selected";else $select="";
																			}
                                                                        ?>
                                                                        <option value="<?php echo $kelas['kd_kelas'] ?>" <?php echo $select; ?>><?php echo $kelas['kelas'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="jml_bed" class="control-label">Jml. Kasur</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="jml_bed" name="jml_bed" class="input-large input-tooltip"
                                                                        value="<?php echo $item['jml_bed'] ?>"   data-original-title="masukkan jumlah kasur " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
