                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kabupaten/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kabupaten" name="kd_kabupaten" class="input-mini input-tooltip"
                                                                        value=""   data-original-title="masukkan kode kabupaten" data-placement="bottom"/>
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_propinsi" class="input-xlarge">
                                                                        ...
                                                                        foreach ($datapropinsi as $propinsi) {
                                                                            # code...
                                                                        ?>
                                                                        <option value="<?php echo $propinsi['kd_propinsi'] ?>"><?php echo $propinsi['propinsi'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kabupaten" name="kabupaten" class="input-xlarge input-tooltip"
                                                                        value=""   data-original-title="masukkan kabupaten " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
