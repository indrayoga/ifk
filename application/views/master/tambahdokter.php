                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/dokter/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span6">
                                                            <div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" name="kd_dokter" id="kd_dokter" class="span4 input-tooltip"
																		value="" data-original-title="kd dokter" data-placement="bottom"/>
															...
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" name="nama_dokter" id="nama_dokter" class="span10 input-tooltip"
																		value="" data-original-title="nama dokter" data-placement="bottom"/>
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
