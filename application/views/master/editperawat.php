    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/master/perawat/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/master/perawat/"> <i class="icon-list"></i> Daftar</a></li>
													<li><a href="<?php echo base_url() ?>index.php/master/perawat/tambah"> <i class="icon-plus"></i> Tambah</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/perawat/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span6">
                                                            <div class="control-group">
                                                                <label for="kd_perawat" class="control-label">Kode</label>
																<div class="controls with-tooltip">
																	<input <?php if($this->mdokter->isPosted($kd_perawat))echo "readonly"; ?> type="text" name="kd_perawat" id="kd_perawat" class="span4 input-tooltip"
																		value="<?php if(isset($items['kd_perawat']))echo $items['kd_perawat'] ?>" data-original-title="kd perawat" data-placement="bottom"/>
												...
												<div class="row-fluid">
													<div class="span12">
														<div class="span6">
															<div class="control-group">
																<label for="nama_perawat" class="control-label">Nama Perawat</label>
																<div class="controls with-tooltip">
																	<input type="text" name="nama_perawat" id="nama_perawat" class="span10 input-tooltip"
																		value="<?php if(isset($items['nama_perawat']))echo $items['nama_perawat'] ?>" data-original-title="nama perawat" data-placement="bottom"/>
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
												...
												<div class="row-fluid">
													<div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<textarea id="alamat" name="alamat" cols="90" rows="2" class="input-xlarge" style="width:310px"><?php if(isset($items['alamat']))echo $items['alamat'] ?></textarea>
																<span class="help-inline"></span>
															</div>
														</div>																												
													</div>
													...
													<div class="span12">
														<div class="span6">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input align="right" type="text" name="telepon" id="telepon" class="span6 input-tooltip"
																		value="<?php if(isset($items['telepon']))echo $items['telepon'] ?>" data-original-title="telepon" data-placement="bottom"/>
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
