                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/jenistarif/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_jenis_tarif" name="kd_jenis_tarif" class="input-mini input-tooltip"
                                                                        value=""  data-original-title="masukkan kode jenis tarif" data-placement="bottom"/>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="jenis_tarif" name="jenis_tarif" class="input-xlarge input-tooltip"
                                                                        value="" data-original-title="masukkan jenis tarif " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
