    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/jenispegawai/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/jenispegawai"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/jenispegawai/update">
                                                        ...
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="hidden" id="id_jenis_pegawai" name="id_jenis_pegawai" class="input-large input-tooltip"
                                                                        value="<?php echo $item['id_jenis_pegawai'] ?>"   data-original-title="masukkan jenis pegawai " data-placement="bottom"/>
                                                                    <input type="text" id="jenis_pegawai" name="jenis_pegawai" class="input-large input-tooltip"
                                                                        value="<?php echo $item['jenis_pegawai'] ?>"   data-original-title="masukkan jenis pegawai " data-placement="bottom"/>
