                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kecamatan/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kecamatan" name="kd_kecamatan" class="input-mini input-tooltip"
                                                                        value=""   data-original-title="masukkan kode kecamatan" data-placement="bottom"/>
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kabupaten" class="input-xlarge">
                                                                        ...
                                                                        foreach ($datakabupaten as $kabupaten) {
                                                                            # code...
                                                                        ?>
                                                                        <option value="<?php echo $kabupaten['kd_kabupaten'] ?>"><?php echo $kabupaten['kabupaten'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kecamatan" name="kecamatan" class="input-xlarge input-tooltip"
                                                                        value=""   data-original-title="masukkan kecamatan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
