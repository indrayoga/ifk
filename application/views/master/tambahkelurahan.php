                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/kelurahan"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kelurahan/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kelurahan" name="kd_kelurahan" class="input-mini input-tooltip"
                                                                        value=""  data-original-title="masukkan kode kelurahan" data-placement="bottom"/>
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kecamatan" class="input-xlarge">
                                                                        ...
                                                                        foreach ($datakecamatan as $kecamatan) {
                                                                            # code...
                                                                        ?>
                                                                        <option value="<?php echo $kecamatan['kd_kecamatan'] ?>"><?php echo $kecamatan['kecamatan'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kelurahan" name="kelurahan" class="input-xlarge input-tooltip"
                                                                        value=""   data-original-title="masukkan kelurahan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
