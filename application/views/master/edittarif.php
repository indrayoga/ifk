                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    ...
                                                                    foreach ($datapelayanan as $pelayanan) {
                                                                        # code...
                                                                        if($pelayanan['kd_pelayanan']==$item['kd_pelayanan'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    ...
                                                                    foreach ($datakelas as $kelas) {
                                                                        # code...
                                                                        if($kelas['kd_kelas']==$item['kd_kelas'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    ...
                                                                    foreach ($datajenistarif as $jenistarif) {
                                                                        # code...
                                                                         if($jenistarif['kd_jenis_tarif']==$item['kd_jenis_tarif'])$sel="selected=selected"; else $sel="";
                                                                   ?>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    ...
                                                                    foreach ($datacustomer as $customer) {
                                                                        # code...
                                                                         if($customer['cust_code']==$itemtarifcustomer['cust_code'])$sel="selected=selected"; else $sel="";
                                                                    ?>
                                                                    <option value="<?php echo $customer['cust_code'] ?>" <?php echo $sel ?>><?php echo $customer['customer'] ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                    </select>
                                                        ...
                                                        <div class="control-group">
                                                            <div class="controls with-tooltip">
                                                                <table style="width:600px;" id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                                    ...
                                                                    <tbody>
                                                                    <?php
                                                                    foreach ($itemskomponen as $komponen) {
                                                                        # code...
                                                                    ?>
                                                                    <tr>
                                                                        <td class="span5"><?php echo $komponen['nama_component'] ?></td>
                                                                        <td><input style="text-align:right;" type="text" name="component[<?php echo $komponen['kd_component'] ?>]" value="<?php echo $komponen['tarif_component']; ?>" class="komponen_tarif input-small"></td>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <?php $tgl=explode(" ", $item['tgl_berlaku']) ?>
                                                                    <input type="text" name="tgl_berlaku" value="<?php echo convertDate($tgl[0]) ?>" id="tgl_berlaku" data-mask="99-99-9999" class="input-small">
                                                                    <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <?php $tgl1=explode(" ", $item['tgl_berakhir']) ?>
                                                                    <input type="text" name="tgl_berakhir" value="<?php echo convertDate($tgl1[0]) ?>" id="tgl_berakhir" data-mask="99-99-9999" class="input-small">
                                                                    <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
