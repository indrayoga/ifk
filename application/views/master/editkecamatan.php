    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    z=true;
                    $.ajax({
                    url: "<?php echo base_url(); ?>index.php/master/kecamatan/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/master/kecamatan"> <i class="icon-list"></i> Daftar</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/kecamatan/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_kecamatan" class="control-label">Kode Kecamatan</label>
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kd_kecamatan" name="kd_kecamatan" class="input-mini input-tooltip"
                                                                        value="<?php echo $item['kd_kecamatan'] ?>" readonly  data-original-title="masukkan kode kecamatan" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                <label for="kd_kabupaten" class="control-label">Kabupaten</label>
                                                                <div class="controls with-tooltip">
                                                                    <select name="kd_kabupaten" class="input-xlarge">
                                                                        <?php
                                                                        foreach ($datakabupaten as $kabupaten) {
                                                                            # code...
                                                                            $select="";
																			if(isset($item['kd_kabupaten'])){    
																				if($item['kd_kabupaten']==$kabupaten['kd_kabupaten'])$select="selected=selected";else $select="";
																			}
                                                                        ?>
                                                                        <option value="<?php echo $kabupaten['kd_kabupaten'] ?>" <?php echo $select; ?>><?php echo $kabupaten['kabupaten'] ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="kabupaten" name="kecamatan" class="input-large input-tooltip"
                                                                        value="<?php echo $item['kecamatan'] ?>"   data-original-title="masukkan kecamatan " data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
