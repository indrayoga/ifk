                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/master/diagnosadtd/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span5">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <input type="text" id="no_dtd_terperinci" name="no_dtd_terperinci" class="input-medium input-tooltip"
                                                                        value="" data-original-title="masukkan nomor dtd terperinci" data-placement="bottom"/>
                                                                     <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="span12">
                                                        <div class="span5">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls with-tooltip">
                                                                    <textarea id="nama_dtd" name="nama_dtd" cols="90" rows="2" class="input-large" style="width:270px"></textarea>
                                                                    <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                        </div>
