                ...
                <div class="container-fluid outer">
                    <div class="row-fluid">
                      ...
                      <!--BEGIN INPUT TEXT FIELDS-->
						<form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/customer/simpancustomer"'>
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <input type="text" name="cust_code" id="cust_code" value="<?php echo $cust_code; ?>" readonly class="span2 input-tooltip" data-original-title="cust code" data-placement="bottom"/>
