                    ...
                    <div class="span12">
                        <div class="box">
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/gfk/laporangfk/distribusi">
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="span6">
                                ...
                                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                    <thead>
                                        <tr style="font-size:90% !important;">
                                            ...
                                            <th style="text-align:center;">Stok Per tgl (<?php echo date('d-m-Y') ?>)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
