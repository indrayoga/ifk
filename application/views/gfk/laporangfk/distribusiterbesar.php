...
<!-- #content -->
<script src="<?php echo base_url(); ?>assets/js/chartjs/Chart.bundle.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/js/chartjs/Chart.css">
<div id="content">
    <!-- .outer -->
                    ...
                    <div class="span12">
                        <div class="box">
                            <header>
                                ...
                                <div class="toolbar" style="height:auto;">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a target="" class="btn" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php echo base_url() ?>index.php/gfk/laporangfk/excelDistribusiTerbesar/<?php echo $periodeawal ?>/<?php echo $periodeakhir; ?>/<?php if(empty($kd_unit_apt )) echo "null"; else echo $kd_unit_apt; ?>"> <i class="icon-print"></i> Export to Excel</a></li>
                                        <li>
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/gfk/laporangfk/distribusiterbesar">
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="span12">
                                ...
                                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($items as $item):         
                                            ...
                                            $labels[] = addslashes($item['nama_obat']);
                                            $data[] = $item['distribusi'];
                                        ?>
                                            <tr style="font-size:90% !important;">
                                                <td><?php echo $item['nama_obat'] ?></td>
                                                <td style="text-align:right;"><?php echo $item['distribusi'] ?></td>
                                            </tr>                                             
                                        <?php
                                        endforeach;
                                        ?>
                                    ...
                                    <tfoot>
                                        <!-- <tr>
                                            <th colspan="11" style="text-align:right;" class="header">Total Penjualan (Rp) : <input style="text-align:right;width:130px;font-size:95% !important;" type="text" class="input-medium cleared" id="totalpenjualan" value="<?php  echo number_format($totalpenjualan,2,',','.');?>" disabled></th>
                                        </tr> -->
                                    </tfoot>
                                </table>
                            </div>
...
<script type="text/javascript">
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Obat Distribusi Terbesar',
