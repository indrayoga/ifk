...
<script type="text/javascript">
    Mousetrap.bindGlobal('ctrl+r', function() { window.location.href='<?php echo base_url() ?>index.php/gfk/pemakaianpkm/tambah'; return false;});
</script>
<style type="text/css">
.fixed {
    position:fixed;
                    ...
                    <div class="span12">
                        <div class="box">
                            <header class="top">
                                ...
                                <h5>PENCARIAN DATA PEMAKAIAN PUSKESMAS</h5>                         
                                <!-- .toolbar -->
                                <div class="toolbar" style="height:auto;">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="<?php echo base_url() ?>index.php/gfk/pemakaianpkm/tambah"> <i class="icon-plus"></i> Tambah (Ctrl + R)</a></li>
                                        <li>
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/gfk/pemakaianpkm">
                    ...
                    <div class="span12">
                        <div class="box">
                            <header>
                                ...
                                <h5>DAFTAR PEMAKAIAN PUSKESMAS</h5>
                            </header>
                                    ...
                                    <tbody class="with-tooltip">
                                        ...
                                        <tr class="">
                                            ...
                                            <td style="text-align:center;width:160px;">                                                           
                                                <a href="<?php echo base_url() ?>index.php/gfk/pemakaianpkm/ubahpemakaianpkm/<?php echo $item['id_sop'] ?>" class="btn"><i class="icon-edit"></i> Edit</a>
                                                <a href="#" onClick="xar_confirm('<?php echo base_url() ?>index.php/gfk/pemakaianpkm/hapuspemakaianpkm/<?php echo $item['id_sop'] ?>','Apakah Anda ingin menghapus data ini?')" class="btn btn-danger"><i class="icon-remove"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php
                                            //  $no++;
