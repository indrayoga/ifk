...
window.open(
  '<?php echo base_url() ?>index.php/gfk/stokopnamepkm/tambah',
  '_newtab' // <- This is what makes it open in a new window.
    ...
    Mousetrap.bindGlobal('f10', function() { 
        window.location.href='<?php echo base_url() ?>index.php/gfk/stokopnamepkm/tambah'
        return false;
    });
    ...
    $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/gfk/stokopnamepkm/periksastokopnamepkm"; //buat validasi inputan
                z=true;
                $.ajax({
                url: urlnya,
                type:"POST",
            ...
            //data = objToString(data);
                if(parseInt(data.status)==1) //jika berhasil
                {
                    ...
                    $('#error').html('<div class="alert alert-success fade in navbar navbar-fixed-top" style="margin-left:70px;margin-right:70px;"><button data-dismiss="alert" class="close" type="button"><i class="icon-remove"></i></button>'+data.pesan+'</div>');
                        ...
                        window.location.href='<?php echo base_url(); ?>index.php/gfk/stokopnamepkm/ubahstokopnamepkm/'+data.id;
...
<div id="content">
    ...
    <div class="container-fluid outer">
        <div class="row-fluid">
            ...
            <form class="form-horizontal"  id="form" method="POST" action="<?php echo base_url() ?>index.php/gfk/stokopnamepkm/simpanstokopnamepkm">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <header class="top" style="">
                                <div class="icons"><i class="icon-edit"></i></div>
                                <h5>STOKOPNAME PUSKESMAS </h5>
                                <!-- .toolbar -->
                                <div class="toolbar" style="height:auto;">
                                    <ul class="nav nav-tabs">
                                        <li><a class="btn" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php echo base_url() ?>index.php/gfk/stokopnamepkm/"> <i class="icon-list"></i> Daftar </a></li>
                                        <li><button class="btn" id="simpan" type="submit"  name="submit" value="simpan"> <i class="icon-save"></i> Simpan / F12</button></li>
                                        <li><a  class="btn" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php echo base_url() ?>index.php/gfk/stokopnamepkm/tambah"> <i class="icon-plus"></i> Tambah / (F6)</a></li>
                                        <li>
        ...
        $('.barisnamaobat').keyup(function(e){
           ...
           // if(e.keyCode == 13){
                ...
                $('#dataTable6').dataTable( {
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "<?php echo base_url() ?>index.php/gfk/stokopnamepkm/ambildaftarobatbynama/",
                    "sServerMethod": "POST",
