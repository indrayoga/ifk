	...
	$(document).ready(function() {
		$('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/masterapotek/tarifapt/periksabungkus"; //buat validasi inputan
                //console.log($.param(a));
            ...
            //data = objToString(data);
                if(parseInt(data.status)==1) //jika berhasil
                {
                    ...
                    if(parseInt(data.keluar)>0){
                        window.location.href='<?php echo base_url(); ?>index.php/masterapotek/tarifbungkus';
                    }
                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form id="form" class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/masterapotek/tarifapt/caritarifbungkus">                                                												
												<div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="span7">                                                            
															<div class="control-group">
																<label for="tarif_perbungkus" class="control-label">Tarif per Bungkus</label>
																<div class="controls with-tooltip">
																	<input align="right" type="text" id="tarif_perbungkus" name="tarif_perbungkus" value="<?php if(isset($itembungkus['setting']))echo $itembungkus['setting'] ?>" class="span3 input-tooltip" data-original-title="tarif per bungkus" data-placement="bottom"/>																	
																</div>
															</div>                                                            
                                                        </div>														
                                                    </div>	
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <button class="btn btn-primary" type="submit" name="submit" value="simpantarif" id="simpantarif">Simpan Tarif</button>
