                                        ...
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/transapotek/aptreturobat/tambahreturobat"> <i class="icon-plus"></i> Tambah Retur / (Ctrl + R)</a></li>
													<!--<li class="dropdown">
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>DAFTAR RETUR PENERIMAAN OBAT / ALKES</h5>
                                        </header>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(i,l){
					...
					if(data.status_approve=='1') b='Sudah di Approve';
					else b='Belum di Approve';
                    $('#tdapprove').html(': '+b);
