                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>PENCARIAN DATA DISTRIBUSI</h5>							
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/transapotek/aptdistribusi/tambahdistribusiapt"> <i class="icon-plus"></i> Tambah Distribusi / (Ctrl + R)</a></li>
													<!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/aptdistribusi">
												<div class="row-fluid">
													<div class="span12">
														<div class="span4">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" id="no_distribusi" name="no_distribusi" value="<?php echo $no_distribusi; ?>" class="input-medium input-tooltip" data-original-title="masukkan no distribusi yang ingin dicari" data-placement="bottom"/>												
																</div>
															</div>
														</div>
														<!--div class="span6">
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>DAFTAR DISTRIBUSI OBAT / ALKES</h5>
                                        </header>
                                            ...
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                <thead>
                                                    <tr>
														...
														<th width="15%" style="text-align:center;">Tgl. Distribusi</th>
														<th width="52%" style="text-align:center;">Unit Tujuan</th>
                                                ...
                                                <tbody class="with-tooltip">
													...
													?>
													<tr class="showmodal input-tooltip" id="<?php echo $item['no_distribusi']; ?>" data-original-title="double click untuk detil">
														<td style="text-align:center;"><?php echo $item['no_distribusi']; ?></td>
														<td style="text-align:center;"><?php echo $item['tgl_distribusi']; ?></td>
														<td><?php echo $item['unit_tujuan']; ?></td>
														<td style="text-align:center;width:200px;">
                                                            <a href="<?php echo base_url() ?>index.php/transapotek/aptdistribusi/ubahdistribusi/<?php echo $item['no_distribusi'] ?>" class="btn"><i class="icon-edit"></i> Edit</a>
                                                            <?php if($item['posting']){
                                                            ?>
                                                            &nbsp;
                                                            <?php
                                                            ...
                                                            ?>
                                                            <a href="#" onClick="xar_confirm('<?php echo base_url() ?>index.php/transapotek/aptdistribusi/hapusdistribusi/<?php echo $item['no_distribusi'] ?>','Apakah Anda ingin menghapus data ini?')" class="btn btn-danger"><i class="icon-remove"></i> Hapus</a>
                                                            <?php
                                                            } ?>
			...
			<div aria-hidden="true" aria-labelledby="approveModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="detilmodal" style="display: none;width:87%;margin-left:-0;left:90px;top:5px;">
                <div class="modal-header">
                   ...
                   <!--
                    ...
                    -->                 
                    <h3 id="helpModalLabel"><i class="icon-external-link"></i> Detil Distribusi</h3>
                </div>
...
<script type="text/javascript">
	...
	$('.showmodal').dblclick(function(){
        $.ajax({
            url: '<?php echo base_url() ?>index.php/transapotek/aptdistribusi/ambilitem/',
            async:false,
            type:'get',
            ...
            success:function(data){
                //typeahead.process(data)
                    ...
                    $('#tddistribusi').html(': '+data.no_distribusi);
                    $('#tdunitasal').html(': '+data.unit_asal);
                    $('#tdtanggal').html(': '+data.tgl_distribusi);					
        ...
        $.ajax({
            url: '<?php echo base_url() ?>index.php/transapotek/aptdistribusi/ambilitems/',
            async:false,
            type:'get',
            data:{query:$(this).attr('id')},
            success:function(data){
