                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>PENCARIAN DATA PENGAJUAN</h5>							
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/transapotek/aptpengajuan/tambahpengajuan"> <i class="icon-plus"></i> Tambah Pengajuan / (Ctrl + R)</a></li>
													<!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/aptpengajuan">
												<div class="row-fluid">
													<div class="span12">
														<div class="span4">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input type="text" id="no_pengajuan" name="no_pengajuan" class="input-medium input-tooltip" data-original-title="masukkan no pengajuan yang ingin dicari" data-placement="bottom"/>												
																</div>
															</div>
														</div>														
													</div>
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>DAFTAR TRANSAKSI PENGAJUAN OBAT / ALKES</h5>
                                        </header>
                                        <div id="collapse4" class="body">
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody class="with-tooltip">
													...
													?>
															<tr class="showmodal input-tooltip" id="<?php echo $item['no_pengajuan']; ?>" data-original-title="double click untuk detil">
																<td style="text-align:center;"><?php echo $item['no_pengajuan']; ?></td>
																<td style="text-align:center;"><?php echo $item['tgl_pengajuan'] ?></td>
																<td><?php echo $item['keterangan']; ?> </td>
																<td><?php echo $status; ?> </td>
																<td style="text-align:center;width:160px;">
																	<?php if($item['status_approve']==0) { ?>
																		<a href="<?php echo base_url() ?>index.php/transapotek/aptpengajuan/ubahpengajuan/<?php echo $item['no_pengajuan'] ?>" class="btn"><i class="icon-edit"></i> Edit</a>																	
																		<a href="#" onClick="xar_confirm('<?php echo base_url() ?>index.php/transapotek/aptpengajuan/hapuspengajuan/<?php echo $item['no_pengajuan'] ?>','Apakah Anda ingin menghapus data ini?')" class="btn btn-danger"><i class="icon-remove"></i> Hapus</a>
																	<?php } else { ?>
																		<a href="<?php echo base_url() ?>index.php/transapotek/aptpengajuan/ubahpengajuan/<?php echo $item['no_pengajuan'] ?>" class="btn"><i class="icon-edit"></i> Lihat Data</a>
																	<?php } ?>
			...
			<div aria-hidden="true" aria-labelledby="approveModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="detilmodal" style="display: none;width:77%;margin-left:140;left:10px;top:25px;">
                <div class="modal-header">
                   ...
                   <!--
                    ...
                    -->                 
                    <h3 id="helpModalLabel"><i class="icon-external-link"></i> Detil Pengajuan Obat / Alkes</h3>
                </div>
...
<script type="text/javascript">
	...
	$('.showmodal').dblclick(function(){
        $.ajax({
            url: '<?php echo base_url() ?>index.php/transapotek/aptpengajuan/ambilitem/',
            async:false,
            type:'get',
            ...
            success:function(data){
                //typeahead.process(data)
                    ...
                    $('#tdpengajuan').html(': '+data.no_pengajuan);
                    $('#tdtanggal').html(': '+data.tgl_pengajuan1);					
        ...
        $.ajax({
            url: '<?php echo base_url() ?>index.php/transapotek/aptpengajuan/ambilitems/',
            async:false,
            type:'get',
            data:{query:$(this).attr('id')},
            success:function(data){
                ...
                $.each(data,function(i,l){
                    ...
                    $('#bodyinput').append('<tr><td style="text-align:center;">'+no+'</td><td style="text-align:center;">'+l.kd_obat+'</td><td>'+l.nama_obat+'</td><td style="text-align:center;">'+l.satuan_kecil+'</td><td style="text-align:right;">'+l.qty_kcl+'</td><td style="text-align:right;">'+addCommas(l.harga_beli)+'</td><td style="text-align:right;">'+addCommas(l.jumlah)+'</td></tr>');
                    no++;
                });
