...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#totalpengajuan').val(totalpengajuan.toFixed(2));
            ...
            //data = objToString(data);
                if(parseInt(data.status)==1) //jika berhasil
                {
					...
					if(parseInt(data.posting)==3){
						 window.location.href='<?php echo base_url(); ?>index.php/transapotek/aptpengajuan/ubahpengajuan/'+data.no_pengajuan;
					}  
                                ...
                                <div class="span12">
                                        ...
                                        <header class="top" style="">
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li><button <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "disabled";} else {if($kd_applogin==0) echo "disabled";} ?> class="btn" id="simpan" type="submit"  name="submit" value="simpan"> <i class="icon-save"></i> Simpan / (Ctrl+S)</button></li>
                                                    <li>
												...
												<div class="span12">
													<!--div class="span8"-->
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="text" id="keterangan" name="keterangan" value="<?php if(isset($itemtransaksi['keterangan']))echo $itemtransaksi['keterangan'] ?>" class="span7 input-tooltip cleared" data-original-title="keterangan" data-placement="bottom"/>
																<span class="help-inline"></span>																
															</div>
														</div>
													<!--/div-->													
											...
											<div class="box error">
												...
												<!-- .toolbar -->
													<div class="toolbar" style="height:auto;float:left;">
														<ul class="nav nav-tabs">
															<li><button <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "disabled";} else {if($kd_applogin==0) echo "disabled";} ?> class="btn" type="button" id="tambahbaris"> <i class="icon-plus"></i> Tambah Obat (Ctrl+B)</button></li>
															<li><button <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "disabled";} else {if($kd_applogin==0) echo "disabled";} ?> class="btn" type="button" id="hapusbaris"> <i class="icon-remove"></i> Hapus Obat</button></li>
														</ul>
													</div>
												<!-- /.toolbar -->
												</header>
														...
														<tbody id="bodyinput">
															<?php
																if(isset($itemsdetiltransaksi)){
																	...
																	?>
																		<tr style="font-size:80% !important;">
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="checkbox" class="barisinput" /></td>
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="text" name="kd_obat[]" value="<?php echo $itemdetil['kd_obat'] ?>" style="width:150px;" class="input-small bariskodeobat cleared"></td>
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="text" name="nama_obat[]" value="<?php echo $itemdetil['nama_obat'] ?>" style="width:600px;font-size:90% !important;" class="input-xlarge barisnamaobat cleared"></td>
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="text" name="satuan_kecil[]" value="<?php echo $itemdetil['satuan_kecil'] ?>" style="width:100px;" class="input-medium barissatuan cleared" readonly></td>
																			<!--td><input <-?php if($this->mpengajuan->isPosted($no_pemesanan))echo "readonly"; ?> type="text" name="tgl_expire[]" value="<-?php echo $itemdetil['tgl_expire'] ?>" class="input-small baristanggal cleared"></td-->
																			<input type="hidden" name="pembanding[]" value="<?php echo $itemdetil['pembanding'] ?>" class="input-small barispembanding cleared">
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> style="text-align:right;" type="text" name="qty_box[]" value="<?php echo $itemdetil['qty_kcl'] ?>" style="width:70px;font-size:90% !important;" class="input-small barisqtyb cleared"></td>
																			...
																			<td><input <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> style="text-align:right;" type="text" name="harga_beli[]" value="<?php echo number_format($itemdetil['harga_beli'],2,'.','') ?>" style="width:80px;font-size:90% !important" class="input-small barishargabeli cleared"></td>																			
																			<td style="text-align:right;"><input style="text-align:right;" <?php if($this->mpengajuan->isPosted($no_pengajuan)) {echo "readonly";} else {if($kd_applogin==0) echo "readonly";} ?> type="text" name="jumlah[]" style="width:100px;font-size:90% !important;" value="<?php echo number_format($itemdetil['jumlah'],2,'.','') ?>" class="input-medium barisjumlah cleared" readonly></td>																			
																		</tr>
																	<?php
																		//$no++;
																	}
									...
									<div class="row-fluid">
											<div class="box error">
												<header>
													<div class="toolbar" style="height:auto;float:left;">
														<ul class="nav nav-tabs">
															<?php if(!empty($no_pengajuan)) {  
																		  if($this->mpengajuan->isAppExist($no_pengajuan,$kd_applogin)) { //kalo dy berhak approve
																				if(($isapp=$this->mpengajuan->statusisaplogin($no_pengajuan,$kd_applogin))==1) { //kalo dy udh approve?>
																	...
																	<?php } ?>																
															<?php } else { ?>
																<li><button <?php if(empty($no_pengajuan)){ ?>disabled<?php } ?> class="btn" id="btn-approve" type="submit" name="submit" value="approve"> <i class="icon-ok"></i> Approve</button></li>
															<?php } ?>																														
														</ul>
													</div>
												</header>
									...
									<div aria-hidden="true" aria-labelledby="approveModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="pencarian" style="display: none;width:77%;left:34% !important;">
										<div class="modal-header">
											...
											<h3 id="helpModalLabel"><i class="icon-external-link"></i> Daftar Pengajuan</h3>
										</div>
											...
											<div class="body" id="collapse4">
												<table id="dataTable1" class="table table-bordered table-condensed table-hover table-striped">
													...
													<tbody>
														...
														?>
																<tr>
																	<td><?php echo $item['no_pengajuan'] ?></td>
															...
															-->	
																	<td>
																		<a href="<?php echo base_url() ?>index.php/transapotek/aptpengajuan/ubahpengajuan/<?php echo $item['no_pengajuan'] ?>" class="btn"><i class="icon-edit"></i> PILIH</a>
																	</td>
																</tr>                                                    
														<?php
															}
...
<script type="text/javascript">
	...
	$('#tambahbaris').click(function(){
		...
		$('#bodyinput').append('<tr style="font-size:95% !important;"><td><input type="checkbox" class="barisinput cleared" /></td>'+
									...
									'<td><input type="text" name="nama_obat[]" value="" style="width:600px;font-size:95% !important;" class="input-xlarge barisnamaobat cleared"></td>'+
									...
									'<td><input style="text-align:right;" type="text" name="qty_box[]" value="" style="width:70px;font-size:95% !important;" class="input-small barisqtyb cleared"></td>'+
									'<input type="hidden" name="qty_kcl[]" value="" style="width:70px;font-size:95% !important;" class="input-small barisqtyk cleared" readonly>'+
									...
									'<td style="text-align:right;"><input style="text-align:right;" style="width:100px;font-size:95% !important;" type="text" name="jumlah[]" value="" class="input-medium barisjumlah cleared" readonly></td>'+
                                '</tr>');
		...
		$('.barisqtyb, .barishargabeli, .barisnamaobat, .baristanggal').click(function(){  
                $('#bodyinput tr').removeClass('focused'); 
