                                    ...
                                    <div class="box">
                                        <header class="top" style="">
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													...
													<!--li><a target="_blank" class="btn" id="btn-cetak" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php if(!empty($no_permintaan)){ echo base_url() ?>third-party/fpdf/buktipermintaan.php?no_permintaan=<?php echo $no_permintaan;} else echo '#'; ?>" <?php if(empty($no_permintaan)){ ?>disabled<?php } ?>> <i class="icon-print"></i> Cetak</a></li-->
                                                    <?php if($this->session->userdata('kd_unit_apt')!=$this->session->userdata('kd_unit_apt_gudang')) { ?>
                                                    ...
                                                    <!--
                                                    <li><a class="btn" id="btn-bayar" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" data-toggle="modal" data-original-title="Pencarian" data-placement="bottom" rel="tooltip" href="<-?php if(!empty($no_pemesanan) && $this->mpermintaan->isPosted($no_pemesanan)){ ?>#bayartransaksi<-?php } ?>" <-?php if(empty($no_pemesanan) || !$this->mpermintaan->isPosted($no_pemesanan)){ ?>disabled<-?php } ?>> <i class="icon-money"></i> Bayar.</a></li>
                                                    -->                                                    
                                                    <li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
											...
											<!--div class="row-fluid">
												<div class="span12">
													<div class="control-group">
														<label for="tgl_permintaan" class="control-label">Tgl. Permintaan </label>
														<div class="controls with-tooltip">
															<input <-?php if($this->mpermintaan->isPosted($no_permintaan))echo "readonly"; ?> type="text" name="tgl_permintaan" id="tgl_permintaan" class="input-small input-tooltip cleared" data-original-title="tgl permintaan" data-mask="99-99-9999" value="<-?php if(empty($itemtransaksi['tgl_pengajuan']))echo date('d-m-Y'); else echo convertDate($itemtransaksi['tgl_pengajuan']);  ?>" data-placement="bottom"/>
															<span class="help-inline"></span>
														</div>
													</div>												
												</div>
									...
									<div class="row-fluid">
											<div class="box error">
												<header>
													<div class="toolbar" style="height:auto;float:left;">
														<ul class="nav nav-tabs">
															<?php if(!empty($no_permintaan)) {  
																		  if($this->mpermintaan->isAppExist($no_permintaan,$kd_applogin)) { //kalo dy berhak approve
																				if(($isapp=$this->mpermintaan->statusisaplogin($no_permintaan,$kd_applogin))==1) { //kalo dy udh approve?>
																	...
																	<?php } ?>																
															<?php } else { ?>
																<li><button <?php if(empty($no_permintaan)){ ?>disabled<?php } ?> class="btn" id="btn-approve" type="submit" name="submit" value="approve"> <i class="icon-ok"></i> Approve</button></li>
															<?php } ?>																														
														</ul>
													</div>
												</header>
