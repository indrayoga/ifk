											...
											<!-?php } else { ?-->
													<div class="row-fluid">
														<div class="span12">
															<div class="span7">
																<div class="control-group">
																	<label for="nama_unit_apt" class="control-label">Unit</label>
																	<div class="controls with-tooltip">
																		<input type="text" name="nama_unit_apt" id="nama_unit_apt" value="<?php if($unit=$this->mstokopname->namaunit($this->session->userdata('kd_unit_apt'))) echo $unit; ?>" readonly class="span7 input-tooltip" data-original-title="unit apt" data-placement="bottom"/>
														...
														<div id="collapse4" class="body">
															<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
																...
																<tbody class="with-tooltip">
																	...
																	?>
																		<tr style="font-size:100% !important;" class="showmodal input-tooltip" id="<?php echo $item['kd_obat']; ?>" tgl="<?php echo $item['tgl_expire'];?>" unit="<?php echo $item['kd_unit_apt']; ?>" data-original-title="double click untuk edit">
...
<script type="text/javascript">
	...
	$('#nama_obat').keyup(function(e){
		if(e.keyCode == 13){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>index.php/transapotek/stokopname/ambilobatbynama/',
                async:false,
                type:'get',
                data:{query:$(this).val()},
                success:function(data){
                //typeahead.process(data)
					...
					$.each(data,function(i,l){
						//alert(l);
						$('#listobat').append('<tr><td>'+l.kd_obat+'</td><td>'+l.nama_obat+'</td><td>'+l.satuan_kecil+'</td><td><a class="btn" onclick=\'pilihobat("'+l.kd_obat+'","'+l.nama_obat+'")\'>Pilih</a></td></tr>');
					});    
                },
                dataType:'json'                         
            }); 
