                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>ENTRY GOLONGAN OBAT / ALKES</h5>
                                            <!-- .toolbar -->
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/golongan/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_golongan" id="kd_golongan" class="span2 input-tooltip"
																	value="" data-original-title="kd golongan" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="golongan" id="golongan" class="span5 input-tooltip"
																	value="" data-original-title="golongan" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
