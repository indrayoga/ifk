		...
		$('#golongan').focus();
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/golongan/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                ...
                //data = objToString(data);
                    if(parseInt(data.status)==1) //jika berhasil
                    {
						...
						$('#kd_golongan').val(data.kd_golongan);
						if(parseInt(data.posting)==3){
							 window.location.href='<?php echo base_url(); ?>index.php/masterapotek/golongan/edit/'+data.kd_golongan;
						}
					}
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>EDIT GOLONGAN OBAT / ALKES</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/golongan/"> <i class="icon-list"></i> Daftar Golongan</a></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/golongan/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_golongan" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_golongan" id="kd_golongan" class="span2 input-tooltip"
																	value="<?php echo $items['kd_golongan'] ?>" data-original-title="kd golongan" data-placement="bottom"/>
																<span class="help-inline"></span>
																<input type="hidden" name="kd_golongan1" id="kd_golongan1" class="span2 input-tooltip"
																	value="<?php echo $items['kd_golongan'] ?>" data-original-title="kd golongan" data-placement="bottom"/>
															</div>
														</div>
                                                    </div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															<label for="golongan" class="control-label">Golongan Obat</label>
															<div class="controls with-tooltip">
																<input type="text" name="golongan" id="golongan" class="span5 input-tooltip"
																	value="<?php echo $items['golongan'] ?>" data-original-title="golongan" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
