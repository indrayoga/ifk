                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/satuankecil/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="satuan_kecil" id="satuan_kecil" class="span5 input-tooltip"
																	value="" data-original-title="nama satuan" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
