		...
		$('#satuan_kecil').focus();
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/satuankecil/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                ...
                //data = objToString(data);
                    if(parseInt(data.status)==1) //jika berhasil
                    {
						...
						$('#kd_satuan_kecil').val(data.kd_satuan_kecil);
						if(parseInt(data.posting)==3){
							 window.location.href='<?php echo base_url(); ?>index.php/masterapotek/satuankecil/edit/'+data.kd_satuan_kecil;
						}
					}
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>EDIT SATUAN OBAT / ALKES</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/satuankecil/"> <i class="icon-list"></i> Daftar Satuan</a></li>
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/satuankecil/tambah"> <i class="icon-plus"></i> Tambah Satuan</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/satuankecil/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_satuan_kecil" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_satuan_kecil" id="kd_satuan_kecil" class="span2 input-tooltip"
																	value="<?php echo $items['kd_satuan_kecil'] ?>" data-original-title="kd satuan" data-placement="bottom"/>																
																<span class="help-inline"></span>
																<input type="hidden" name="kd_satuan_kecil1" id="kd_satuan_kecil1" class="span2 input-tooltip"
																	value="<?php echo $items['kd_satuan_kecil'] ?>" data-original-title="kd satuan" data-placement="bottom"/>
															</div>
														</div>
                                                    </div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															<label for="satuan_kecil" class="control-label">Nama Satuan</label>
															<div class="controls with-tooltip">
																<input type="text" name="satuan_kecil" id="satuan_kecil" class="span5 input-tooltip"
																	value="<?php echo $items['satuan_kecil'] ?>" data-original-title="nama satuan" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
