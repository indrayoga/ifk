    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/satuanbesar/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Edit Satuan Besar</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/satuanbesar/"> <i class="icon-list"></i> Daftar</a></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/satuanbesar/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_satuan_besar" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_satuan_besar" id="kd_satuan_besar" class="span1 input-tooltip"
																	value="<?php echo $items['kd_satuan_besar'] ?>" readonly data-original-title="kd satuan besar" data-placement="bottom"/>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="satuan_besar" id="satuan_besar" class="span5 input-tooltip"
																	value="<?php echo $items['satuan_besar'] ?>" data-original-title="satuan besar" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
