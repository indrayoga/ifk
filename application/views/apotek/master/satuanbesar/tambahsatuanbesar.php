                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/satuanbesar/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_satuan_besar" id="kd_satuan_besar" class="span1 input-tooltip"
																	value="" data-original-title="kd satuan besar" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="satuan_besar" id="satuan_besar" class="span5 input-tooltip"
																	value="" data-original-title="satuan besar" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
