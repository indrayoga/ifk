												...
												<tbody>
													...
													foreach ($items as $item) {																		
														...
														if($stok<=$minstok1){   
															if($stok<=0){ ?>
																<tr style="font-size:95% !important;">
																	...
																	<td style="text-align:center;background-color: red;" ><input type="checkbox" value="<?php echo $kode; echo "."; echo $tgl;?>" class="barisinput cleared"/></td>
														...
														<?php } else { ?>
																<tr style="font-size:95% !important;">
																	<!--td style="text-align:center;background-color: #00FF7F;" ><input type="checkbox" value="<-?php echo $kode; echo "."; echo $tgl;?>" class="barisinput cleared" checked /></td-->
																	<td style="text-align:center;background-color: yellow;" ><input type="checkbox" value="<?php echo $kode; echo "."; echo $tgl;?>" class="barisinput cleared"/></td>
														...
														<?php } } else { ?>
															<tr style="font-size:95% !important;">
																<td style="text-align:center;"><input type="checkbox" value="<?php echo $kode; echo "."; echo $tgl;?>" class="barisinput cleared" /></td>
