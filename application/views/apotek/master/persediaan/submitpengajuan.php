                ...
                <div class="container-fluid outer">
                    <div class="row-fluid">
                      ...
                      <!--BEGIN INPUT TEXT FIELDS-->
						<form class="form-horizontal"  id="form" method="POST" action="<?php echo base_url() ?>index.php/masterapotek/persediaan/editsubmit">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="box">
                                        <header class="top" style="">
                                            <div class="icons"><i class="icon-edit"></i></div>
                                            <h5>SUBMIT PENGAJUAN OBAT / ALKES</h5>
                                            <!-- .toolbar -->
											...
											<div class="box error">
												...
												<div class="body collapse in" id="defaultTable">
													<table class="table responsive">
																...
																if(isset($itemsdetiltransaksi)){
																	...
																	?>
																		<tr style="font-size:80% !important;">
																			...
																			<td><input type="text" name="nama_obat[]" value="<?php echo $itemdetil['nama_obat'] ?>" style="width:600px;font-size:90% !important;" class="input-xlarge barisnamaobat cleared"></td>
																			...
																			<td><input style="text-align:right;" type="text" name="qty_box[]" value="<?php echo $itemdetil['qty_kcl'] ?>" style="width:70px;font-size:90% !important;" class="input-small barisqtyb cleared"></td>
														...
														<tfoot>
															<tr>
																<th colspan="14" style="text-align:right;" class="header">Total (Rp) : <input type="text" class="input-medium cleared" id="totalsubmit" style="text-align:right" disabled></th>
															</tr>
														</tfoot>
													</table>
												</div>
...
<script type="text/javascript">
	...
	$('#batal').click(function(){
		...
		if (tanya){
			...
			//alert("Submit batal")
			//location.reload();
			window.location.href='<?php echo base_url(); ?>index.php/masterapotek/persediaan/submit/'+nomor;
		}
	})
    ...
    function totaltransaksi(){
        var totalsubmit=0; var total1=0;
        $('.barisjumlah').each(function(){
            var val=$(this).val(); 
            if(val=='')val=0;
            totalsubmit=totalsubmit+parseFloat(val);             
