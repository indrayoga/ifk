                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>EDIT SUB GOLONGAN OBAT / ALKES</h5>
                                            <!-- .toolbar -->
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/subgolongan/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_sub" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_sub" id="kd_sub" class="span2 input-tooltip"
																	value="<?php echo $items['kd_sub'] ?>" data-original-title="kd sub golongan" data-placement="bottom"/>
																<span class="help-inline"></span>
																<input type="hidden" name="kd_sub1" id="kd_sub1" class="span1 input-tooltip"
																	value="<?php echo $items['kd_sub'] ?>" data-original-title="kd sub golongan" data-placement="bottom"/>
															</div>
														</div>
                                                    </div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="sub_golongan" id="sub_golongan" class="span5 input-tooltip"
																	value="<?php echo $items['sub_golongan'] ?>" data-original-title="sub golongan" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
												...
												<div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<select class="input-medium cleared" name="kd_golongan" id="kd_golongan">
																...
																?>
																<option value="<?php if(!empty($gol)) echo $gol['kd_golongan'] ?>" <?php echo $select; ?>><?php echo $gol['golongan'] ?></option>
																<?php
																	}
																?>
																</select>
