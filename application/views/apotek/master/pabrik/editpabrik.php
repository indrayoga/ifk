                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/pabrik/update">
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_pabrik" id="kd_pabrik" class="span1 input-tooltip"
																	value="<?php echo $items['kd_pabrik'] ?>" readonly data-original-title="kd pabrik" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="nama_pabrik" id="nama_pabrik" class="span5 input-tooltip"
																	value="<?php echo $items['nama_pabrik'] ?>" data-original-title="nama pabrik" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
