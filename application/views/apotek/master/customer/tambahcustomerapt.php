                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/aptcustomer/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="cust_code" id="cust_code" class="span1 input-tooltip"
																	value="" data-original-title="cust code" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="customer" id="customer" class="span5 input-tooltip"
																	value="" data-original-title="customer" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
