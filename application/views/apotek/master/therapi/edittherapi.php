		...
		$('#satuan_kecil').focus();
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/therapi/peheriksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                ...
                //data = objToString(data);
                    if(parseInt(data.status)==1) //jika berhasil
                    {
						...
						if(parseInt(data.posting)==3){
							 window.location.href='<?php echo base_url(); ?>index.php/masterapotek/therapi/edit/'+data.id;
						}
					}
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>EDIT KELAS THERAPI OBAT / ALKES</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/therapi/"> <i class="icon-list"></i> Daftar</a></li>
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/therapi/tambah"> <i class="icon-plus"></i> Tambah</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/therapi/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <input type="hidden" name="kd_therapi" value="<?php echo $items['kd_therapi'] ?>" id="kd_therapi" class="span2 input-tooltip">
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															<label for="therapi" class="control-label">Nama Kelas Therapi</label>
															<div class="controls with-tooltip">
																<input type="text" name="therapi" id="therapi" class="span5 input-tooltip"
																	value="<?php echo $items['therapi'] ?>" data-original-title="nama" data-placement="bottom"/>
