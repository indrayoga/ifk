																		...
																		<option value="">--pilih pabrik--</option>
																			...
																			foreach ($datapabrik as $pab) {
																				...
																				if(isset($items['kd_pabrik'])){    
																					if($items['kd_pabrik']==$pab['kd_pabrik'])$select="selected=selected";else $select="";
																				}
																			?>
																	...
																	<div class="controls with-tooltip">
																		...
																		<option value="">--pilih Kelas--</option>																
																			...
																			foreach ($datatherapi as $therapi) {
																				# code...
																				if($therapi['kd_therapi']==$items['kd_therapi'])$sel="selected=selected"; else $sel="";
																			?>
																		...
																		<option value="">--pilih sub--</option>
																			...
																			foreach ($datasub as $sub) {
																				...
																				if(isset($items['kd_sub'])){    
																					if($items['kd_sub']==$sub['kd_sub'])$select="selected=selected";else $select="";
																				}
																			?>
														...
														if(isset($databarcode)){
															...
															<tr>
																...
																<td><select  name='kd_satuan_barcode[]' class='input-medium'>
																	<?php 
																	foreach ($datakecil as $kecil) {
																		if($kecil['kd_satuan_kecil']==$bar['kd_satuan'])$sel="selected"; else $sel="";
																	?>
