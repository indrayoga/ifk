											...
											<div class="box">
												...
												<div id="div-1" class="accordion-body collapse in body">
														...
														<div class="span12">
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	...
																	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Generic &nbsp&nbsp<input <?php if($this->session->userdata('kd_unit_apt')!=$this->session->userdata('kd_unit_apt_gudang'))echo "disabled";?> type="checkbox" id="generic" name="generic" value="1" />
																	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Aktif &nbsp&nbsp<input <?php if($this->session->userdata('kd_unit_apt')!=$this->session->userdata('kd_unit_apt_gudang'))echo "disabled";?> type="checkbox" id="is_aktif" name="is_aktif" value="1" />
																	<span class="help-inline"></span>
																</div>
															</div>																												
														</div>
													...
													<!--div class="control-group">
														...
														<div class="controls with-tooltip">
															<button <-?php if($this->session->userdata('kd_unit_apt')!=$this->session->userdata('kd_unit_apt_gudang'))echo "disabled"; ?> class="btn btn-primary" type="submit"><i class="icon-ok"></i> Simpan</button>
															<button <-?php if($this->session->userdata('kd_unit_apt')!=$this->session->userdata('kd_unit_apt_gudang'))echo "disabled"; ?> class="btn " type="reset"><i class="icon-undo"></i> Reset</button>
														</div>
													</div-->													
