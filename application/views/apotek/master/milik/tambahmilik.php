	 ...
	 $(document).ready(function() {
        ...
        $('#form').ajaxForm({
            beforeSubmit: function(a,f,o) {
                ...
                $('body').addClass('body1');
                var urlnya="<?php echo base_url(); ?>index.php/masterapotek/milik/periksamilik"; //buat validasi inputan
                //console.log($.param(a));
            ...
            //data = objToString(data);
                if(parseInt(data.status)==1) //jika berhasil
                {
                    ...
                    if(parseInt(data.keluar)>0){
                        window.location.href='<?php echo base_url(); ?>index.php/masterapotek/milik';
                    }
                ...
                <div class="container-fluid outer">
                    <div class="row-fluid">
                      ...
                      <!--BEGIN INPUT TEXT FIELDS-->
						<form class="form-horizontal" id="form" method="POST" action="<?php echo base_url() ?>index.php/masterapotek/milik/simpanmilik">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a class="btn" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php echo base_url() ?>index.php/masterapotek/milik/"> <i class="icon-list"></i> Daftar</a></li>
                                                    <li><a class="btn" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php echo base_url() ?>index.php/masterapotek/milik/tambahmilik"> <i class="icon-plus"></i> Tambah</a></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                                <div class="control-group">
                                                    <label for="kd_milik" class="control-label">Kode </label>
                                                    <div class="controls with-tooltip">
                                                        <input type="text" name="kd_milik" id="kd_milik" value="<?php echo $kd_milik; ?>" readonly class="span1 input-tooltip" data-original-title="kd milik" data-placement="bottom"/>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <input type="text" id="milik" name="milik" value="<?php if(isset($items['milik']))echo $items['milik'] ?>" class="span5 input-tooltip" data-original-title="milik" data-placement="bottom"/>
                                                    </div>
                                                </div>											
                                        </div>
                                    </div>
