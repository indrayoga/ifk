    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/subjenis/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Edit Sediaan Obat</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/subjenis/"> <i class="icon-list"></i> Daftar</a></li>
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/subjenis/tambah"> <i class="icon-plus"></i> Tambah</a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/subjenis/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_sub_jenis" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_sub_jenis" id="kd_sub_jenis" class="span1 input-tooltip"
																	value="<?php echo $items['kd_sub_jenis'] ?>" readonly data-original-title="kd sub jenis" data-placement="bottom"/>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															<label for="sub_jenis" class="control-label">Nama Sediaan Obat</label>
															<div class="controls with-tooltip">
																<input type="text" name="sub_jenis" id="sub_jenis" class="span5 input-tooltip"
																	value="<?php echo $items['sub_jenis'] ?>" data-original-title="sub jenis" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
