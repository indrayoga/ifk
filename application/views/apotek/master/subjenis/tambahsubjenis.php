                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/subjenis/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_sub_jenis" id="kd_sub_jenis" class="span1 input-tooltip"
																	value="" data-original-title="kd sub jenis" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="sub_jenis" id="sub_jenis" class="span5 input-tooltip"
																	value="" data-original-title="sub jenis" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
