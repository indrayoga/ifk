    ...
    $(document).ready(function() {
            ...
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/jenisobat/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Edit Jenis Obat</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/jenisobat/"> <i class="icon-list"></i> Daftar</a></li>
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/jenisobat/update">
                                                <input type="hidden" name="mode" value="edit">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="kd_jenis_obat" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="kd_jenis_obat" id="kd_jenis_obat" class="span1 input-tooltip"
																	value="<?php echo $items['kd_jenis_obat'] ?>" readonly data-original-title="kd jenis obat" data-placement="bottom"/>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="jenis_obat" id="jenis_obat" class="span5 input-tooltip"
																	value="<?php echo $items['jenis_obat'] ?>" data-original-title="jenis obat" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
