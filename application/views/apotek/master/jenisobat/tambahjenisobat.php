                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/jenisobat/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_jenis_obat" id="kd_jenis_obat" class="span1 input-tooltip"
																	value="" data-original-title="kd jenis obat" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="jenis_obat" id="jenis_obat" class="span5 input-tooltip"
																	value="" data-original-title="jenis obat" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
