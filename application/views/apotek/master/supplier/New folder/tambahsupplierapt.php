                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <h5>Entry Supplier</h5>
                                            <!-- .toolbar -->
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
                                                    <li><a href="<?php echo base_url() ?>index.php/masterapotek/aptsupplier/"> <i class="icon-list"></i> Daftar</a></li>
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/aptsupplier/tambah"> <i class="icon-plus"></i> Tambah</a></li>
													<!--<li class="dropdown">
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_supplier" id="kd_supplier" class="span1 input-tooltip"
																	value="" data-original-title="kd supplier" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="nama" id="nama" class="span5 input-tooltip"
																	value="" data-original-title="nama" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="alamat" id="alamat" class="span7 input-tooltip"
																	value="" data-original-title="alamat" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="telp" id="telp" class="span2 input-tooltip"
																	value="" data-original-title="telp" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="ket" id="ket" class="span7 input-tooltip"
																	value="" data-original-title="ket" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
