                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/aptsupplier/update">
                                                    ...
                                                    <div class="span12">                                                        
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_supplier" id="kd_supplier" class="span1 input-tooltip"
																	value="<?php if(isset($items['kd_supplier']))echo $items['kd_supplier'] ?>" readonly data-original-title="kd distributor" data-placement="bottom"/>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="nama" id="nama" class="span5 input-tooltip"
																	value="<?php if(isset($items['nama']))echo $items['nama'] ?>" data-original-title="nama distributor" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															<label for="alamat" class="control-label">Alamat Distributor</label>
															<div class="controls with-tooltip">
																<input type="text" name="alamat" id="alamat" class="span7 input-tooltip"
																	value="<?php if(isset($items['alamat']))echo $items['alamat'] ?>" data-original-title="alamat" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="telp" id="telp" class="span2 input-tooltip"
																	value="<?php if(isset($items['telp']))echo $items['telp'] ?>" data-original-title="telp" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
