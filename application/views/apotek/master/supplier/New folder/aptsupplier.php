                                            ...
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/masterapotek/aptsupplier">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
                                                        <input type="text" id="nama" name="nama" value="<?php echo $nama; ?>" class="span3 input-tooltip" data-original-title="masukkan nama distributor yang ingin dicari" data-placement="bottom"/>												
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                        ...
                                        <div id="collapse4" class="body">
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody>
													...
													<tr>
														<td><?php echo $no; ?></td>
														<td><?php echo $item['kd_supplier']; ?></td>
