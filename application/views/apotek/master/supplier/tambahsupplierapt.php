                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/aptsupplier/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="kd_supplier" id="kd_supplier" class="span2 input-tooltip"
																	value="" data-original-title="kode distributor" data-placement="bottom" readonly />
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="nama" id="nama" class="span5 input-tooltip"
																	value="" data-original-title="nama distributor" data-placement="bottom"/>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
												...
												<div class="row-fluid">
													<div class="span12">														
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<textarea id="alamat" name="alamat" cols="90" rows="2" class="input-xxlarge" style="width:460px"></textarea>
																<span class="help-inline"></span>
															</div>
														</div>														
													</div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																...
																&nbsp&nbsp Kode Pos &nbsp&nbsp<input align="right" type="text" name="kode_pos" id="kode_pos" class="span1 input-tooltip"
																	value="" data-original-title="kode pos" data-placement="bottom"/>
															</div>
														</div>														
													</div>
												</div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input align="right" type="text" name="telp" id="telp" class="span2 input-tooltip"
																	value="" data-original-title="telp. distributor" data-placement="bottom"/>
																<span class="help-inline"></span>
																&nbsp&nbsp Fax. &nbsp&nbsp<input align="right" type="text" name="fax" id="fax" class="span2 input-tooltip"
																	value="" data-original-title="fax. distributor" data-placement="bottom"/>
															</div>
														</div>														
													</div>
												</div>
														...
														<div class="control-group">
															...
															<div class="controls with-tooltip">
																<input type="text" name="email" id="email" class="span3 input-tooltip"
																	value="" data-original-title="email distributor" data-placement="bottom"/>
																<span class="help-inline"></span>
																Aktif <input type="checkbox" id="is_aktif" name="is_aktif" value="1" />
															</div>
														</div>														
													</div>
												</div>
