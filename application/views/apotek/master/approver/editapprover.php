                ...
                <div class="container-fluid outer">
                    <div class="row-fluid">
                      ...
                      <!--BEGIN INPUT TEXT FIELDS-->
                            <div class="row-fluid">
								<form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/approver/update">
									<div class="row-fluid">
										<div class="span12">
											<div class="box">
												<header>
																...
																<div class="control-group">
																	...
																	<div class="controls with-tooltip">
																		<input type="text" name="kd_app" id="kd_app" class="span2 input-tooltip"
																			value="<?php echo $item['kd_app']; ?>" data-original-title="kd approver" data-placement="bottom" readonly />
																		<span class="help-inline"></span>
																		Urut Approval <input type="text" name="urut" id="urut" class="span2 input-tooltip"
																			value="<?php echo $item['urut']; ?>" data-original-title="urut" data-placement="bottom" />
																		<span class="help-inline"></span>
																	</div>
																</div>
															</div>
																	...
																	<div class="controls with-tooltip">
																		<select name="id_pegawai" id="id_pegawai" class="input-large">
																			...
																			foreach ($datakecil as $kecil) {
																				# code...
																				$select="";
																				if(isset($item['id_pegawai'])){    
																					if($item['id_pegawai']==$kecil['id_pegawai'])$select="selected=selected";else $select="";
																				}
																			?>
																			<option value="<?php echo $kecil['id_pegawai'] ?>" <?php echo $select; ?>><?php echo $kecil['nama_pegawai'] ?></option>
																			<?php
																			}
																			?>
																		</select>
																		...
																		<select name="id_user" id="id_user" class="input-small">
																			...
																			foreach ($datausername as $user) {
																				...
																				if(isset($item['id_user'])){    
																					if($item['id_user']==$user['id_user'])$select="selected=selected";else $select="";
																				}
																			?>
																			<option value="<?php echo $user['id_user'] ?>" <?php echo $select; ?>><?php echo $user['username'] ?></option>
																			<?php
																			}
																			?>
																		</select>																		
