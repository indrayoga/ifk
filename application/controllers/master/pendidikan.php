...
class Pendidikan extends CI_Controller {
	...
	public function index()
	{
		...
		$data=array(
			'items'=>$this->mmaster->ambilData('pendidikan','pendidikan like "%'.$pendidikan.'%"')
			
		);
		$this->load->view('master/header',$dataheader);
		$this->load->view('master/pendidikan',$data);
	...
	public function tambah()
	{
		...
		$this->load->view('master/header',$dataheader);
		$this->load->view('master/tambahpendidikan',$data);
		$this->load->view('footer',$datafooter);
	}
	...
	public function periksa()
	{
		...
		if(empty($kd_pendidikan)){
			$jumlaherror++;
			$msg['id'][]="kd_pendidikan";
			$msg['pesan'][]="Kode Harus di Isi";
		}

		if($mode!="edit"){
			if($this->mmaster->isExist('pendidikan','kd_pendidikan',$kd_pendidikan)){
				$jumlaherror++;
				$msg['id'][]="kd_pendidikan";
		...
		if(empty($pendidikan)){
			$jumlaherror++;
			$msg['id'][]="pendidikan";
			$msg['pesan'][]="Kolom pendidikan Harus di Isi";
		}
	...
	public function simpan(){
		...
		$this->mmaster->insert('pendidikan',$data);		
	...
	public function update(){
		...
		$this->mmaster->update('pendidikan',$data,'kd_pendidikan="'.$kd_pendidikan.'"');		
		$msg['pesan']="Data Berhasil Di Simpan";
		$msg['status']=1;
	...
	public function edit($id=""){
		...
		$data=array(
			'item'=>$this->mmaster->ambilItemData('pendidikan','kd_pendidikan="'.$id.'"'),
		);
		$this->load->view('master/header',$dataheader);
		$this->load->view('master/editpendidikan',$data);
		$this->load->view('footer',$datafooter);

	}
	public function hapus($id=""){
		if(!empty($id)){
			$this->mmaster->delete('pendidikan','kd_pendidikan="'.$id.'"');
