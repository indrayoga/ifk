...
class Kabupaten extends Rumahsakit {
	...
	public function index()
	{
		...
		$data=array(
			'items'=>$this->mdaerah->ambilDataRelasi('kabupaten a','propinsi b','a.kd_propinsi=b.kd_propinsi','kabupaten like "%'.$kabupaten.'%"')
	...
	public function tambah()
	{
		...
		$data=array(
			'datapropinsi'=>$this->mdaerah->ambilData('propinsi')
		);

		$this->load->view('master/header',$dataheader);
		$this->load->view('master/tambahkabupaten',$data);
		$this->load->view('footer',$datafooter);
	}
	...
	public function periksa()
	{
		...
		if($mode!="edit"){
			if($this->mdaerah->isExist('kabupaten','kd_kabupaten',$kd_kabupaten)){
				$jumlaherror++;
				$msg['id'][]="kd_kabupaten";
	...
	public function simpan(){
		...
		$this->mdaerah->insert('kabupaten',$data);		
	...
	public function update(){
		...
		$this->mdaerah->update('kabupaten',$data,'kd_kabupaten="'.$kd_kabupaten.'"');		
		$msg['pesan']="Data Berhasil Di Simpan";
		$msg['status']=1;
	...
	public function edit($id=""){
		...
		$data=array(
			'item'=>$this->mdaerah->ambilItemData('kabupaten','kd_kabupaten="'.$id.'"'),
			'datapropinsi'=>$this->mdaerah->ambilData('propinsi')
		);
		$this->load->view('master/header',$dataheader);
		$this->load->view('master/editkabupaten',$data);
		$this->load->view('footer',$datafooter);

	}
	public function hapus($id=""){
		if(!$this->muser->isAkses("925")){
			$this->restricted();
			return false;
		}
		if(!empty($id)){
			$this->mdaerah->delete('kabupaten','kd_kabupaten="'.$id.'"');
